...
import (
	...
	barcontrollerv1alpha1 "github.com/govargo/bar-controller/pkg/apis/barcontroller/v1alpha1"
	versioned "github.com/govargo/bar-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/govargo/bar-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/govargo/bar-controller/pkg/generated/listers/barcontroller/v1alpha1"
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&barcontrollerv1alpha1.Bar{}, f.defaultInformer)
}
